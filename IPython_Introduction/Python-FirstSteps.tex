...
\newthought{\ipythoninline{help()}} is the native python help command.
...
\newthought{\ipythoninline{?}} is IPython's own help command, and it is often nicer
...
\newthought{\textinline{<regex>}\ipythoninline{?}} allows you to use
...
\newthought{\PY{o}{\PYZpc{}}\ipythoninline{quickref}}
...
\newthought{\textinline{<tab>}} will provide code completion.
  Type \ipythoninline{numpy.arc}\textinline{<tab>} and IPython
  will suggest a list of inverse trig functions.

\newthought{\textinline{Control-m h}} Provides a list of hotkeys for IPython
  notebooks.
